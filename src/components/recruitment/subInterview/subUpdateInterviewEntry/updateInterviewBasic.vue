	...
	<div class="tab-pane fade in active martop" id="updateBasic">
		<form action="">
			<div class="form-group clearfix">
                <label for="name" class="col-md-2 control-label text-right nopad">姓名：</label>
                <div class="col-md-3">
                  <input type="text" class="form-control" id="name" placeholder="Name" v-model="interviewBase.name">
                </div>
				<label class="col-md-2 ontrol-label text-right nopad">性别：</label>
				<div class="col-md-3">
					<!-- <button @click="getSex"></button> -->
					<select class="form-control" v-model="interviewBase.sex"> 
						<option v-for="(item,index) in sexStatus" :key="index" :value="item.label">
							{{item.label}}
						</option>
					</select>
				</div>
			...
			<div class="form-group clearfix">
				...
				<div class="col-md-3">
					<select class="form-control" v-model="interviewBase.ploitical">
						<option v-for="(item,index) in ploiticalState" :key="index" :value="item.label">
						{{item.label}}
						</option>
					</select>
				</div>
			...
			<div class="form-group clearfix">
				...
				<div class="col-md-3">
					<select class="form-control" v-model="interviewBase.marital">
						<option v-for="(item,index) in maritalStatus" :key="index" :value="item.label">
						{{item.label}}
						</option>
					</select>
				</div>
			...
			<div class="form-group clearfix">
				<label class="col-md-2 ontrol-label text-right nopad">血型：</label>
				<div class="col-md-3">
					<select class="form-control" v-model="interviewBase.bloodType">
						<option v-for="(item,index) in bloodTypes" :key="index" :value="item.label">
						{{item.label}}
						</option>
					</select>
				</div>
				<label class="col-md-2 ontrol-label text-right nopad">户口性质：</label>
				<div class="col-md-3">
					<select class="form-control" v-model="interviewBase.accountProp">
						<option v-for="(item,index) in accountPropState" :key="index" :value="item.label">
						{{item.label}}
						</option>
					</select>
				</div>
