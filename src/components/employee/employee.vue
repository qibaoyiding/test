<template>
	...
	<div>
		...
		<div class="row add-mt">
			<div style="padding: 0; width:3.3%; display:inline-block; float:left; margin-left:15px; line-heig
			ht: 34px; font-size:0;">
				<p>项目：</p>
			</div>
			...
			<div style="padding-right:1.5%;">
				...
				<button type="button" class="btn btn-info pull-right m_r_10" v-on:click="getEmployee('all')">显示所有</button>
			</div>
		</div>
		<div class="row">
