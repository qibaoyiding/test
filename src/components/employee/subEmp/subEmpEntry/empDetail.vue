<template>
	<div class="tab-pane fade" id="detailed">
		<div class="martop1 clearfix">
			...
			<div class="form-group col-md-6 clearfix">
				<label class="col-md-4 control-label text-right nopad">籍　　贯：</label>
				<div class="col-md-8">
					<input type="text" class="form-control" v-model="personalDetail.uHomeTown" placeholder="">
				</div>
			</div>
			<div class="form-group col-md-6 clearfix">
			  <label class="col-md-4 control-label text-right nopad">民　　族：</label>
			  <div class="col-md-8">
		...
		<div class="martop1 clearfix">
			<div class="form-group col-md-6 clearfix">
				<label class="col-md-4 control-label text-right nopad">驾　　龄：</label>
				<div class="col-md-8">
