		...
		<div class="modal-body">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 clear-mp" style="line-height: 34px;">
						<label>类别：</label>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 clear-mp" style="width:205px;">
			...
			<div class="row add-mt">
					<div class="form-inline col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 clear-mp" style=" padding:0">
							<label for="firstTime" class="control-label">离职类型：</label>
						</div>
						<div class="input-group col-xs-4 col-sm-4 col-md-4 col-lg-4" style="width:176px;float:left">
						...
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 clear-mp" style="float:left;padding-left:15px">
							<label for="secondTime" class="control-label">离职原因：</label>
						</div>
						<div class="input-group col-xs-4 col-sm-4 col-md-4 col-lg-4" style="width:160px;">
