		...
		<div class="modal-dialog" style="position:relative;">
			<div class="modal-content">
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="position: inherit;"><span aria-hidden="true">&times;</span></button>
					<h4></h4>
				</div>
			...
			<button data-dismiss="modal" class="btn btn-danger" @click="addPositionInfo" style="bottom: 20px;">确认</button>
		</div>
	</div>
</template>
